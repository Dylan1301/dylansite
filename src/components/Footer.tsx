			...
			<Container className="flex items-center justify-between text-sm text-muted-foreground">
				...
				<nav aria-label="Social">
					<ul className="flex gap-4">
						<li>
							<a className="hover:underline underline-offset-4" href="https://github.com/" target="_blank" rel="noopener noreferrer">
								GitHub
							</a>
						</li>
						<li>
							<a className="hover:underline underline-offset-4" href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer">
								LinkedIn
							</a>
						</li>
						<li>
